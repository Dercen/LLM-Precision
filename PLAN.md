...
Measured window counts (OPT tokenizer, seqlen 2048), all confirmed against §5.6: wikitext2 140, `c4`/`c4_new` exactly 256, `ptb` 45, `ptb_new` 47. SmolLM2-135M gives 148 on wikitext2.
